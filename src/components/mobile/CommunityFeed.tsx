          ...
          {currentPost && (
            <div className="flex-1 overflow-y-auto space-y-4">
              ...
              <div className="flex items-start gap-3 pb-4 border-b">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-orange-400 to-pink-400 flex items-center justify-center text-white flex-shrink-0">
              ...
              {currentPost.comments.map(comment => (
                <div key={comment.id} className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400 flex items-center justify-center text-white flex-shrink-0 text-sm">
                    {comment.userName[0]}
                  </div>
                  <div className="flex-1">
                    <p className="text-sm">
